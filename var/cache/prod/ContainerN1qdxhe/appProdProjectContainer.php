...
class appProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'prestashopbundle\\security\\admin\\sessionrenewer' => 'PrestaShopBundle\\Security\\Admin\\SessionRenewer',
        ...
        $this->fileMap = [
            ...
            'mbo.event_subscriber.module_event_subsciber' => 'getMbo_EventSubscriber_ModuleEventSubsciberService.php',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('4ncBQKAwt+', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_89fcc9620a42c562ce3d5547a026ced709f36d321de925ea50a8d80c2d32ac87');
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('module.upgrade', [0 => function () {
            return ${($_ = isset($this->services['mbo.event_subscriber.module_event_subsciber']) ? $this->services['mbo.event_subscriber.module_event_subsciber'] : $this->load('getMbo_EventSubscriber_ModuleEventSubsciberService.php')) && false ?: '_'};
    ...
    {
        return $this->services['assets._version__default'] = new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('1.7.8.9', '%s?%s');
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('VZzHuL79PLip6SpZDmxTV7Jk7RrpDSaJw3UZIIYQEKOIAxUeBL7p2nQTRi4qQDA5'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('VZzHuL79PLip6SpZDmxTV7Jk7RrpDSaJw3UZIIYQEKOIAxUeBL7p2nQTRi4qQDA5');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                46 => ($this->targetDirs[3].'/modules/psgdpr/translations'),
                47 => ($this->targetDirs[3].'/modules/ps_mbo/translations'),
                ...
                53 => ($this->targetDirs[3].'/modules/ps_searchbarjqauto/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'VZzHuL79PLip6SpZDmxTV7Jk7RrpDSaJw3UZIIYQEKOIAxUeBL7p2nQTRi4qQDA5',
