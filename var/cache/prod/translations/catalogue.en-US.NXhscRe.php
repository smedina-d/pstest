...
$catalogue = new MessageCatalogue('en-US', array (
  ...
  array (
    ...
    'Address contains invalid field values' => 'Address contains invalid field values',
    'No file was uploaded.' => 'No file was uploaded.',
    ...
    'This field is invalid, it must contain a positive integer' => 'This field is invalid, it must contain a positive integer.',
  ...
  array (
    ...
    'The module %name% could not be found on Addons.' => 'The module %name% could not be found on Addons.',
  ...
  array (
    ...
    'If enabled, all messages will be saved in the "Customer Service" page under the "Customer" menu.' => 'If enabled, all messages will be saved in the "Customer Service" page under the "Customer Service" menu.',
  ...
  array (
    ...
    'Review this credit slip and download it on our shop, go to the <a href="{order_slip_url}" target="_blank">%credit_slips_label%</a> section of your customer account.' => 'Review this credit slip and download it on our shop, go to the <a href="{order_slip_url}" target="_blank">%credit_slips_label%</a> section of your customer account.',
...
',
  ...
  array (
    ...
    'Refresh' => 'Refresh',
    'Oops! Please correct the item(s) below, and then click "Refresh" to test the compatibility of your new system.' => 'Oops! Please correct the item(s) below, and then click "Refresh" to test the compatibility of your new system.',
...
Once you enable the "%generate_rtl_label%" option, any RTL-specific file that you might have added to your theme might be deleted by the created stylesheet.',
  ...
  array (
    ...
    'This page is not yet compatible with the multistore feature. To access the page, please [1]disable the multistore feature[/1].' => 'This page is not yet compatible with the multistore feature. To access the page, please [1]disable the multistore feature[/1].',
  ...
  array (
    ...
    'Product succesfully removed' => 'Product succesfully removed',
    'Unable to remove product from list' => 'Unable to remove product from list',
    'Product succesfully updated' => 'Product succesfully updated',
    ...
    'Gift ideas for Juliette' => 'Gift ideas for Juliette',
  ),
  ...
  array (
    ...
    'Add an image before product name on delivery slip' => 'Add an image before product name on delivery slip',
    ...
    'If you choose to create this discount for all invoices, only one discount will be created per order invoice.' => 'If you choose to create this discount for all invoices, only one discount will be created per order invoice.',
...
Thanks for your patience.',
  ...
  array (
    ...
    'If you want a category to appear in the menu of your shop, go to [1]Modules > Modules & Services > Installed modules.[/1] Then, configure your menu module.' => 'If you want a category to appear in the menu of your shop, go to [1]Modules > Modules & Services > Installed modules.[/1] Then, configure your menu module.',
    ...
    'This is the net sales price for your customers. The retail price (tax incl.) will automatically be calculated using the selected tax rate.' => 'This is the net sales price for your customers. The retail price (tax incl.) will automatically be calculated using the selected tax rate.',
    ...
    'To specify the suppliers of this product\'s combinations you can go to [1]{combinations_label}[/1] tab.' => 'To specify the suppliers of this product\'s combinations you can go to [1]{combinations_label}[/1] tab.',
  ),
