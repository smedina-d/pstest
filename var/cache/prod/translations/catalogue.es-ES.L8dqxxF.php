...
$catalogue = new MessageCatalogue('es-ES', array (
  ...
  array (
    ...
    'Lifetime of front office cookies' => 'Duración de las cookies del Front Office',
    ...
    'Disable all overrides' => 'Desactivar todos los overrides',
    'Enable or disable all classes and controllers overrides.' => 'Activar o desactivar todos los overrides de clases y controladores.',
    ...
    'Addons API stability channel' => 'Estabilidad de la API de complementos',
  ...
  array (
    ...
    'Set the amount of hours during which the front office cookies are valid. After that amount of time, the customer will have to log in again.' => 'Establece la cantidad de horas durante las cuales las cookies del Front Office son válidas. Después de ese tiempo, el cliente tendrá que iniciar sesión de nuevo.',
...
',
    ...
    'https://doc.prestashop.com/display/PS17/Import' => 'https://doc.prestashop.com/pages/viewpage.action?pageId=54264587',
...
',
  ...
  array (
    ...
    'Advanced stock management has incorrect value. Not set for product %name% ' => 'La Administración Avanzada de Stock tiene un valor incorrecto. No se ha establecido para el producto %name% ',
    'Advanced stock management is not enabled, cannot enable on product %name% ' => 'La Administración Avanzada de Stock no está activada. No se puede activar para el producto %name% ',
  ...
  array (
    ...
    'Advanced settings in [1]%settings_label%[/1]' => 'Configuración avanzada en [1]%settings_label%[/1]',
    ...
    'New product on experimental page' => 'Nuevo producto en la página experimental',
    'Go to catalog' => 'Ir al catálogo',
    'Add new product' => 'Añadir nuevo producto',
    'Edit on experimental page' => 'Editar en la página experimental',
    ...
    'Back to standard page' => 'Volver a la página estándar',
  ...
  array (
    ...
    'To add "tags," click inside the field, write something, and then press "Enter."' => 'Para añadir "etiquetas", haz clic en el campo, escribe la etiqueta y por último presiona "Enter"',
    ...
    'If you want to quickly create a new category, you can do it here. Don’t forget to then go to the Categories page to fill in the needed details (description, image, etc.). A new category will not automatically appear in your shop\'s menu, please read the Help about it.' => 'Si desea crear rápidamente una nueva categoría, puede hacerlo aquí. No olvide ir a la página Categorías para rellenar los campos necesarios (descripción, imagen, etc.). Una nueva categoría no aparecerá automáticamente en el menú de su tienda, lea la ayuda al respecto.',
    ...
    'This is the net sales price for your customers. The retail price (tax incl.) will automatically be calculated using the selected tax rate.' => 'Este es el precio de venta neto para sus clientes. El precio de venta (imp. incl.) se calculará automáticamente utilizando la tasa de impuestos seleccionada.',
...
Las categorías desactivadas se muestran en cursiva.',
    ...
    'To specify the suppliers of this product\'s combinations you can go to [1]{combinations_label}[/1] tab.' => 'Para especificar los proveedores de las combinaciones de este producto puede ir a la pestaña [1]{combinations_label}[/1].',
  ),
  ...
  array (
    ...
    'The experimental product page is not enabled. To enable it, go to the %sExperimental Features%s page.' => 'La página de producto experimental no está habilitada. Para habilitarla, vaya a la página %sCaracterísticas experimentales%s.',
  ...
  array (
    ...
    'Used to override the title tag value. If left blank, the default title value is used.' => 'Se utiliza para sobrescribir el valor de la etiqueta del título. Si se deja en blanco, se utiliza el valor del título predeterminado.',
    ...
    'Indicate the complete URL to an online Zip file that contains your new theme. For instance, "http://example.com/files/theme.zip".' => 'Indica la URL completa del archivo Zip que contiene tu nuevo tema. Por ejemplo, "http://ejemplo.com/archivos/tema.zip".',
...
Una vez actives la opción "%generate_rtl_label%", cualquier archivo específico RTL que hayas añadido al tema podría ser eliminado por la hoja de estilo creada.',
  ...
  array (
    ...
    'Email subject translation file not found in %path%' => 'El archivo de traducción del asunto del correo electrónico no se encuentra en %path%',
  ...
  array (
    ...
    'Failed to override constant %1$s in class %2$s.' => 'Error al sobrescribir la constante %1$s en la clase %2$s.',
    ...
    'The module %name% could not be found on Addons.' => 'El módulo %name% no puso ser encontrado en Addons. ',
...
' => 'https://www.prestashop.com/es/recursos/documentacion?utm_source=back-office&utm_medium=profile&utm_campaign=resources-en&utm_content=download17',
    'Customers' => 'Clientes',
    'Orders' => 'Pedidos',
  ...
  array (
    ...
    'It must be entered as follows:' => 'Debe introducirse de la siguiente manera:',
    ...
    'Address contains invalid field values' => 'La dirección contiene valores de campo no válidos.',
    'No file was uploaded.' => 'Ningun archivo fue subido.',
    ...
    'Custom field text cannot be longer than %limit% characters' => 'El texto del campo personalizado está limitado a %limit% caracteres',
    'There are not enough products in stock' => 'No hay suficientes productos en stock',
    'Positive product quantity is required.' => 'Se requiere una cantidad positiva de producto.',
...
',
    ...
    'This field is invalid, it must contain a positive integer' => 'Este campo no es válido, debe contener un número entero positivo.',
  ...
  array (
    ...
    'This page is not yet compatible with the multistore feature. To access the page, please [1]disable the multistore feature[/1].' => 'Esta página aún no es compatible con la función multitienda. Para acceder a la página, [1]desactive la función multitienda[/1].',
  ...
  array (
    ...
    'Include amount of initial voucher: ' => 'Incluir la cantidad del cupón de descuento inicial: ',
    'Exclude amount of initial voucher: ' => 'Excluir la cantidad del cupón de descuento inicial: ',
    'Amount of your choice: ' => 'Importe de tu elección: ',
    'This order has been partially paid by voucher. Choose the amount you want to refund: ' => 'Este pedido ha sido pagado parcialmente con un cupón de descuento. Elige el importe que quieres reembolsar: ',
    'Product(s) price: ' => 'Precio del producto(s): ',
    'Product(s) price, excluding amount of initial voucher: ' => 'Precio del producto(s), excluyendo el importe del cupón de descuento inicial: ',
    'Order no. ' => 'Pedido nº. ',
...
Saludos',
  ...
  array (
    ...
    'Add an image before product name on delivery slip' => 'Añadir una imagen antes del nombre del producto en el albarán de entrega',
    ...
    'If you choose to create this discount for all invoices, only one discount will be created per order invoice.' => 'Si decides crear este descuento para todas las facturas, solo se creará un descuento por factura de pedido.',
  ...
  array (
    ...
    'A return product was successfully created.' => 'Devolución de producto creada correctamente.',
    ...
    'It looks like the value is invalid:' => 'Parece que el valor no es válido:',
    'Percent or amount value must be greater than 0.' => 'El porcentaje o la cantidad debe ser mayor que 0.',
...
Gracias por su paciencia.',
  ...
  array (
    ...
    'IP addresses allowed to access the front office even if the shop is disabled. Please use a comma to separate them (e.g. 42.24.4.2,127.0.0.1,99.98.97.96)' => 'Direcciones IP autorizadas para el acceso a su Front Office cuando está desactivada. Utilizar comas para separarlas (ej., 42.24.4.2,127.0.0.1,99.98.97.96)',
  ...
  array (
    ...
    'We are thrilled to introduce you to the fuzzy search, one of the new features from 1.7.7! Please note that it is still in beta version, so feel free to share improvement ideas on GitHub to have it enhanced.' => '¡Estamos encantados de presentarte la búsqueda difusa, una de las nuevas características de PrestaShop 1.7.7! Debes tener en cuenta que todavía está en versión beta, así que siéntete libre de compartir ideas de mejora en GitHub para mejorarla.',
  ...
  array (
    ...
    'Review this credit slip and download your invoice on our shop, go to the <a href="{history_url}" target="_blank">Credit slips</a> section of your customer account.' => 'Revise este abono y descargue su factura desde nuestra tienda, vaya a la sección <a href="{history_url}" target="_blank">Abonos</a> de su cuenta de cliente.',
    'Review this credit slip and download it on our shop, go to the <a href="{order_slip_url}" target="_blank">%credit_slips_label%</a> section of your customer account.' => 'Revise este abono y descárguelo desde nuestra tienda, vaya a la sección <a href="{order_slip_url}" target="_blank">%credit_slips_label%</a> de su cuenta de cliente.',
    ...
    'Thank you for your order on [1]{shop_name}[/1]!' => 'Gracias por realizar su pedido en [1]{shop_name}[/1]!',
    'Total' => 'Total',
    ...
    'There are now less than [1]{last_qty}[/1] of [1]{product}[/1] in stock.' => 'Actualmente hay menos de [1]{last_qty}[/1] [1]{product}[/1] en stock.',
  ...
  array (
    ...
    'Refresh' => 'Actualizar',
    'Oops! Please correct the item(s) below, and then click "Refresh" to test the compatibility of your new system.' => '¡Oops! Por favor, corrige el (los) siguiente(s) punto(s) marcado(s) como error(es), y a continuación, haz clic en el botón "Actualizar información" con el fin de comprobar de nuevo la compatibilidad del sistema.',
  ...
  array (
    ...
    'Choose SVG for best customization. Other accepted file formats: jpg, png, gif' => 'Elige SVG para la mejor calidad. Otros formatos de archivo aceptados: jpg, png, gif',
  ...
  array (
    ...
    'Adds a block containing the customer\'s wishlists.' => 'Añade un bloque que contiene la lista de productos deseados del cliente.',
  ...
  array (
    ...
    'Product succesfully removed' => 'Producto eliminado correctamente',
    'Unable to remove product from list' => 'No se puede eliminar el producto de la lista',
    'Product succesfully updated' => 'Producto actualizado correctamente',
    ...
    'Gift ideas for Juliette' => 'Ideas de regalo para María',
  ),
  ...
  array (
    'Mail alerts' => 'Alertas por correo electrónicos',
    ...
    'Order edit' => 'Modificación del pedido',
  ...
  array (
    ...
    'Translate' => 'Traducir',
    'Front office' => 'Front Office',
    'Live translation cannot be enabled. The English Upside Down language is missing and cannot be installed. Please reset the module to try again. ' => 'No se pudo activar la traducción en vivo. No se pudo encontrar el idioma English Upside Down y no se pudo instalar. Por favor, reinicia el módulo para volver a intentarlo. ',
  ),
  ...
  array (
    ...
    'Sends e-mail notifications to customers and merchants regarding stock and order modifications.' => 'Envía notificaciones a los  clientes y los comerciantes respecto a los cambios de stock y pedidos.',
    'Cannot update settings' => 'No se pueden actualizar los ajustes',
    'Please type one (or more) e-mail address' => 'Por favor, escribe una (o más) direcciones de correo electrónico',
    'Invalid e-mail:' => 'Dirección de correo electrónico inválida:',
    'Settings updated successfully' => 'Configuración actualizada correctamente',
    'No message' => 'No hay mensaje',
    'Customer notifications' => 'Notificaciones de cliente',
    'Product availability' => 'Disponibilidad del producto',
  ...
  array (
    'Your e-mail address is invalid' => 'Su dirección de correo electrónico es inválida',
  ...
  array (
    ...
    'Unable to add link for the following shop(s): %s' => 'No se pudo añadir el enlace para la(s) siguiente(s) tienda(s): %s',
    'The link has been removed.' => 'El enlace ha sido eliminado.',
    'Unable to remove link for the following shop(s): %s' => 'No se pudo eliminar el enlace para la(s) siguiente(s) tienda(s): %s',
    ...
    'CMS' => 'CMS',
    'Shops' => 'Tiendas',
    'Choose product ID' => 'Elige el ID de producto',
    ...
    'Indicate the ID number for the product' => 'Indica el ID del producto',
    'Product ID #' => 'ID de producto #',
    'Please select just one item' => 'Selecciona un solo elemento',
  ...
  array (
    ...
    'Displays social media sharing buttons (Twitter, Facebook and Pinterest) on every product page.' => 'Muestra botones para compartir en redes sociales (Twitter, Facebook y Pinterest) en cada página de producto.',
  ...
  array (
    ...
    'Enrich your stats, add statistics about your visits and visitors.' => 'Enriquece tus estadísticas, agrega estadísticas sobre tus visitas y visitantes.',
  ),
  ...
  array (
    ...
    'Accept wire payments by displaying your account details during the checkout and make it easy for your customers to purchase on your store.' => 'Aceptar pagos por transferencia bancaria mostrando los detalles de tu cuenta durante el proceso de pago, haciendo más fácil para tus clientes comprar en tu tienda.
',
  ...
  array (
    ...
    'Password input of at least 5 characters' => 'Contraseña de al menos 5 caracteres',
  ...
  array (
    ...
    'Password must be between 5 and 72 characters long' => 'La contraseña debe tener entre 5 y 72 caracteres como máximo.',
    ...
    'This category does not exist.' => 'Ésta categoría no existe.',
  ...
  array (
    ...
    '%label%:' => '%label%:',
    'Close' => 'Cerrar',
    '%copyright% %year% - Ecommerce software by %prestashop%' => '%copyright% %year% - tienda online creada con %prestashop%',
  ...
  array (
    ...
    'Select a default quantity, and reference, for each combination the generator will create for this product.' => 'Seleccione una cantidad predeterminada y una referencia para todas las combinaciones que el generador va a crear en este producto',
    ...
    'Send' => 'Enviar',
    'You can add a comment here.' => 'Puedes añadir un comentario aquí.',
    'Customer ID:' => 'ID del cliente:',
    'Order #' => 'Pedido #',
    'Product #' => 'Producto #',
    'Subject:' => 'Asunto:',
    ...
    'The locale must be installed' => 'La configuración regional debe estar instalada',
    'Multiple value separator' => 'Separador de valor múltiple',
    'Please name your data matching configuration in order to save it.' => 'Establece un nombre a su configuración de coincidencia de datos para guardarla.',
    'Match your data' => 'Haz coincidir tus datos',
    'Please match each column of your source file to one of the destination columns.' => 'Por favor, haz coincidir cada columna de tu archivo de origen con una de las columnas de destino.',
    'Load a data matching configuration' => 'Cargar una configuración de coincidencia de datos',
    'Load' => 'Cargar',
    'Save your data matching configuration' => 'Guarda tu configuración de coincidencia de datos',
    'Two columns cannot have the same type of values' => 'Dos columnas no pueden tener el mismo tipo de valores',
    'This column must be set:' => 'Esta columna debe establecerse:',
    'Rows to skip' => 'Filas a saltar',
    'Indicate how many of the first rows of your file should be skipped when importing the data. For instance set it to 1 if the first row of your file contains headers.' => 'Indica cuántas de las primeras filas de tu archivo deben ser omitidas cuando se importan los datos. Por ejemplo, indica 1 si la primera fila de tu archivo contiene cabeceras.',
    ...
    'Please note that for security reasons, you can only add modules that are being distributed on PrestaShop Addons, the official marketplace.' => 'Ten en cuenta que por razones de seguridad solo puedes añadir módulos distribuidos por el marketplace oficial PrestaShop Addons.',
    'Search on PrestaShop Marketplace:' => 'Buscar en el Marketplace de PrestaShop:',
    'Or' => 'O',
    'Module' => 'Módulo',
    ...
    'Would you like to delete the content related to this module ?' => '¿Quieres eliminar el contenido relacionado con este módulo?',
    'Confirm reset' => 'Confirmar restablecimiento',
    'No - reset only the parameters' => 'No - restablecer solo los parámetros',
    ...
    'Uninstall the selection' => 'Desinstalar la selección',
    'by' => 'por',
    'You bought this module on PrestaShop Addons. Thank You.' => 'Has comprado este módulo en PrestaShop Addons. Gracias.',
    'Bought' => 'Comprado',
    'This module is available on PrestaShop Addons' => 'Este módulo está disponible en PrestaShop Addons',
    ...
    'Enable PHP\'s OpenSSL extension' => 'Activar la extensión openSSL de PHP',
    ...
    'What\'s the risk?' => '¿Cuál es el riesgo?',
    ...
    'Otherwise you can look for similar modules on the official marketplace. [1]Click here to browse PrestaShop Addons[/1].' => 'De lo contrario, puedes buscar módulos similares en el marketplace oficial. [1]Haz clic aquí para navegar a través de PrestaShop Addons[/1].',
    'Back' => 'Atrás',
    ...
    'You are about to install "%s", a module which is not compatible with your country.' => 'Vas a instalar "%s", un módulo que no es compatible con tu país.',
    ...
    'Click here to browse PrestaShop Addons.' => 'Haz clic aquí para navegar por Prestashop Addons.',
    ...
    'Choose a file' => 'Seleccionar archivo',
    ...
    'Go to the dashboard' => 'Ir al cuadro de mandos',
    'See the document' => 'Ver el documento',
    'Set payment form' => 'Establecer forma de pago',
    'Add note' => 'Añadir nota',
    'Edit note' => 'Editar nota',
    'Existing' => 'Existente',
    'New' => 'Nuevo',
    ...
    'Change' => 'Cambiar',
    'Gift' => 'Regalo',
    'Search for an existing product by typing the first letters of its name.' => 'Busca un producto existente escribiendo las primeras letras de su nombre.',
    ...
    'Can I add my own theme?' => '¿Puedo añadir mi propio tema?',
    'Please note that for security reasons, you can only add themes that are being distributed on PrestaShop Addons, the official marketplace.' => 'Ten en cuenta que por razones de seguridad, solo puedes añadir temas que se distribuyen en PrestaShop Addons, el marketplace oficial.',
    'You can also create a new theme below.' => 'También puedes crear un nuevo tema a continuación.',
    'Choose layouts' => 'Seleccionar diseños',
    ...
    'The following module(s) were not installed properly:' => 'Los siguientes módulos no se instalaron correctamente:',
    ...
    'Display' => 'Mostrar',
    'result(s)' => 'resultado(s)',
    'Please fill at least one field to perform a search in this list.' => 'Rellena al menos un campo para realizar una búsqueda en esta lista.',
    'Refresh list' => 'Actualizar lista',
    'Show SQL query' => 'Mostrar consulta SQL',
    'Export to SQL Manager' => 'Exportar al gestor SQL',
    'Shop group' => 'Grupo de tiendas',
    ...
    'If you check a field, change its value, and save, the multistore behavior will not apply to this shop (or group), for this particular parameter.' => 'Si marcas un campo, cambias su valor y lo guardas, el comportamiento multitienda no se aplicará a esta tienda (o grupo), para este parámetro en particular.',
    'You can\'t change the value of this configuration field in the context of this shop.' => 'No se puede cambiar el valor de este campo de configuración para esta tienda.',
    'Set required fields for this section' => 'Establece los campos requeridos para esta sección',
    'Required Fields' => 'Campos requeridos',
    'Select the fields you would like to be required for this section.' => 'Selecciona los campos que quieras sean requeridos para esta sección.',
    'Field Name' => 'Nombre del campo',
    'All shops' => 'Todas las tiendas',
    ...
    'Please name this shortcut:' => 'Por favor, renombre este acceso rápido:',
    'Remove from QuickAccess' => 'Eliminar de acceso rápido',
    'Add current page to QuickAccess' => 'Añadir esta página al Acceso rápido',
    'Manage quick accesses' => 'Administrar accesos rápidos',
    'Search (e.g.: product reference, customer name…)' => 'Buscar (p. ej.: referencia de producto, nombre de cliente...)',
    ...
    'View my shop' => 'Ver mi tienda',
    '%1$s on line %2$s in file %3$s' => '%1$s en línea %2$s en archivo %3$s',
    'This field will be modified for all your shops.' => 'Este campo se modificará en todas tus tiendas.',
    'This field will be modified for all shops in this shop group:' => 'Este campo se modificará en las tiendas del grupo de tiendas:',
    'This field will be modified for this shop:' => 'Este campo se modificará en la tienda:',
    'A new order has been placed on your shop.' => 'Se ha recibido un nuevo pedido en tu tienda.',
    'Order number:' => 'Número de pedido:',
    'Total:' => 'Total:',
    'From:' => 'De:',
    ...
    'PrestaShop was unable to log in to Addons. Please check your credentials and your Internet connection.' => 'PrestaShop no pudo iniciar sesión en Addons. Por favor verifica tus datos de acceso y tu conexión de Internet.',
    'Search for a product' => 'Buscar un producto',
    'Your shop is in debug mode.' => 'Tu tienda está en modo depuración.',
    'All the PHP errors and messages are displayed. When you no longer need it, [1]turn off[/1] this mode.' => 'Se muestran todos los errores y mensajes de PHP. Cuando ya no los necesites, [1]desactiva[/1] este modo.',
    'Debug mode' => 'Modo depuración',
    'Your shop is in maintenance.' => 'Tu tienda está en mantenimiento.',
    'Your visitors and customers cannot access your shop while in maintenance mode.%s To manage the maintenance settings, go to Shop Parameters > Maintenance tab.' => 'Tus visitantes y clientes no pueden acceder a tu tienda mientras está en modo mantenimiento. %s Para gestionar los ajustes de mantenimiento dirígete a la pestaña Parámetros de la tienda > Mantenimiento.',
    'Maintenance mode' => 'Modo mantenimiento',
    ...
    'Enable this module for all shops' => 'Activar este módulo en todas las tiendas',
    'Disable' => 'Desactivar',
    'Enable' => 'Activar',
    ...
    'Slideshows' => 'Diapositivas',
    'Comparison site & Feed management' => 'Sitio de comparación y gestión de feeds',
    'Marketplace' => 'Marketplace',
    'Mobile' => 'Móvil',
    'Dashboard' => 'Cuadro de mandos',
    'Internationalization & Localization' => 'Internacionalización y Localización',
    'Emailing & SMS' => 'Envío de correo y SMS',
    'Social Networks' => 'Redes sociales',
    'Social & Community' => 'Redes Sociales y Comunidad',
    'Module not found' => 'Módulo no encontrado',
    'Modules to update' => 'Módulos a actualizar',
